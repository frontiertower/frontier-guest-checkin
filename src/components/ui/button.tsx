...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all cursor-pointer disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-primary-hover dark:hover:bg-primary-hover",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90 dark:shadow-none",
        outline:
          "border border-border bg-transparent text-foreground hover:bg-surface-3 dark:hover:bg-surface-3",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-surface-3 dark:hover:bg-surface-3",
        ghost:
          "hover:bg-surface-3 hover:text-foreground dark:hover:bg-surface-3",
